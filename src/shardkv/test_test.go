...
import "labs-6.824/src/porcupine"
import "labs-6.824/src/models"
import "testing"
import "strconv"
import "time"
import "fmt"
...
// this tests the various sources Gid which a re-starting
...
func TestChallenge2Partial(t *testing.T) {
	...
	// LEAVE 100 + 102
	// 101 can get old shards Gid 102, but not Gid 100. 101 should start
